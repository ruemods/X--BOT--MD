...
const { request, RequestError } = require('undici');
...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        if (options.getProfilePicUrl) {
            ...
            try {
                const { body, statusCode } = await request(pfpUrl, {
                    method: 'GET',
                ...
                if (statusCode === 200) {
                    ...
                    m.groupInviteMessage.jpegThumbnail = buffer;
                }
            } catch (error) {
    ...
    if ('sections' in message && !!message.sections) {
        const listMessage = {
            ...
            listType: message.hasOwnProperty('listType')
                ? message.listType
